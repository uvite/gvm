...
import (
	...
	"github.com/uvite/gvm/pkg/cloudapi"
	"github.com/uvite/gvm/pkg/lib"
	"github.com/uvite/gvm/pkg/lib/netext"
	"github.com/uvite/gvm/pkg/lib/netext/httpext"
...
func TestNewName(t *testing.T) {
	...
	cases := []struct {
		...
		{
			url: &url.URL{
				Opaque: "github.com/uvite/gvm/pkg/samples/http_get.js",
			},
			expected: "http_get.js",
		},
		{
			url:      mustParse("http://github.com/uvite/gvm/pkg/samples/http_get.js"),
			expected: "http_get.js",
		},
		{
